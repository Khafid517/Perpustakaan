...
module.exports = {
    serviceAddAnggota: (data, callBack)=>{
        db.query(
            `insert into anggota(nama_anggota, gender, alamat, telepon, email, password)
            values (?,?,?,?,?,?)`,
            [
                data.nama_anggota,
                data.gender,
    ...
    serviceUpdateAnggota: (data, callBack)=>{
        db.query(
            `update anggota set nama_anggota=?, gender=?, alamat=?, telepon=?, email=?, password=? where id_anggota=?`,
            [
              data.nama_anggota,
              data.gender,
              data.alamat,
